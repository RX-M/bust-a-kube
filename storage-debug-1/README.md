...
applied, all resources are successfully created but the pod goes into a `Pending` state.
...
```
kubectl apply -f https://raw.githubusercontent.com/RX-M/bust-a-kube/master/volume-debug-1/problem.yaml
```
